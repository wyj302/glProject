...
GLuint generateAttachmentTexture(GLboolean depth, GLboolean stencils);
//------------------------------------------------------------
bool keys[1024];
...
int main(int argc, char* argv[])
{
	...
	glUniform1i(glGetUniformLocation(shaderLightingPass.Program, "gPoitionDepth"), 0);
